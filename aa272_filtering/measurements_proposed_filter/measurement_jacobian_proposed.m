%==========================================================================
%
% measurement_jacobian_proposed  Continuous measurement Jacobian from 
% current state.
%
%   C = measurement_jacobian_proposed(x,t,prop,gps)
%   C = measurement_jacobian_proposed(x,t,prop,gps,c)
%
% Author: Tamas Kis
...
%
%==========================================================================
function C = measurement_jacobian_proposed(x,t,prop,gps,l)
    ...
    drhodr_c = dydX_pseudorange(rc_ecef,r_sat_ecef,R_eci2ecef,w_eci);
    ...
    drhodr_d = dydX_pseudorange(rd_ecef,r_sat_ecef,...
        R_eci2ecef,w_eci);
    ...
    % storing partial derivatives of chief GRAPHIC measurements
    C(1:l,1:3) = drhodr_c;
    ...
    % storing partial derivatives of deputy/chief SDCP measurements
    C((2*l+1):(3*l),1:3) = -drhodr_c;
    ...
    % storing partial derivatives of chief GRAPHIC measurements w.r.t. 
    % chief clock bias
    C(1:l,7) = 1;
    ...
    % storing partial derivatives of deputy/chief SDCP measurements w.r.t.
    % clock biases
    C((2*l+1):(3*l),7) = -1;
    C((2*l+1):(3*l),15) = 1;
