%% RUN_FILTER_PROPOSED.m 
% Astrodynamics Toolbox
%
% Runs the proposed filter for the AA 272 project.
%
% Author: Tamas Kis
...
h = @(x,t) measurement_model_proposed(x,t,false,false,prop,gps,l,...
    zeros(l,1),zeros(l,1));

% continuous Jacobians
A = @(x,u,t) dynamics_jacobian(x,t,prop,chief,deputy);
C = @(x,t) measurement_jacobian_proposed(x,t,prop,gps,l);
...
% true measurements
y = true_measurement_proposed(x_true,chief_simdata.t,prop,gps,l);
